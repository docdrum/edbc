...
class TextScreen:
    ...
    def buildButtons(self):
        ...
        self.lines[3] = self.replaceStart(self.lines[3],
                '[' + self.button[19] + ']')
        self.lines[6] = self.replaceStart(self.lines[6],
                '[' + self.button[18] + ']')
        self.lines[9] = self.replaceStart(self.lines[9],
                '[' + self.button[17] + ']')
        self.lines[12] = self.replaceStart(self.lines[12],
                '[' + self.button[16] + ']')
        self.lines[15] = self.replaceStart(self.lines[15],
                '[' + self.button[15] + ']')
        self.lines[3] = self.replaceEnd(self.lines[3],
                '[' + self.button[5] + ']')
        self.lines[6] = self.replaceEnd(self.lines[6],
                '[' + self.button[6] + ']')
        self.lines[9] = self.replaceEnd(self.lines[9],
                '[' + self.button[7] + ']')
        self.lines[12] = self.replaceEnd(self.lines[12],
                '[' + self.button[8] + ']')
        self.lines[15] = self.replaceEnd(self.lines[15],
                '[' + self.button[9] + ']')
